<%@ page import="es.euroformac.javaee.service.impl.NewsServiceImpl" %>
<%@ page import="es.euroformac.javaee.model.News" %>
<%@ page import="java.util.List" %>
<%
    //Crear un objeto de la clase NewsServiceImpl
    NewsServiceImpl newsService = new NewsServiceImpl();

    //Obtener la noticia con id de la url
    String id = request.getParameter("id");
    News noticia = newsService.getNewsById(Integer.parseInt(id));
    ...
    <div id="main">
        <div class="inner">
            ...
            <section>
                <header class="main">
                   <%
                        out.println("<h1>" + noticia.getTitle() + "</h1>");
                ...
                <h3>
                    <%
                        out.println(noticia.getSubTitle());
                    %>
                </h3>

                <p>
                    <%
                        out.println(noticia.getText());
                    %>
                </p>
               ...
               <%-- <hr class="major"/>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis dapibus rutrum facilisis. Class aptent taciti sociosqu ad
                    ...
                    auctor sit amet. Pellentesque leo mauris, consectetur id ipsum sit amet, fersapien risus, commodo eget turpis at,
                ...
                <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Pellentesque venenatis dolor imperdiet dolor mattis
                    ...
                    sit amet, fersapien risus, commodo eget turpis at, elementum convallis elit. Pellentesque enim turpis, hendrerit
